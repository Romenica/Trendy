<%-- 
    Document   : index.jsp
    Created on : 28 ago. 2023, 15:45:15
    Author     : Linda
--%>
...
<%ArrayList<Descuento> descuento= (ArrayList<Descuento>) request.getAttribute("descuento");
    int numPage = 1;
    int numReg = 10;
    int countReg = 0;
    if(descuentos == null)
...
<html>
    <head>
       ...
       <title>Buscar Descuento</title>
    </head>
    <body>
        <jsp:include page="/Views/Shared/headerBody.jsp" /> 
        <main class="container">
           <h5>Buscar Descuento</h5>
           <form action="Descuentos" method="post">
               ...
               <div class="row">
                   <div class="input-field col 16 s12">
                       ...
                       <a href="Descuento?accion=create" class="waves-effect waves-ligth btn blue">Nuevo</a>
                   </div>
               </div>
           </form>
                                    ...
                                    <tr data-page="<%=tempNumPage%>">
                                        ...
                                        <td>
                                            <div style="display: flex">
                                                <a href="Descuento?accion=edit&id=<%=descuento.getId()%>" 
                                                   title="Mofificar" class="waves-effect waves-light btn green">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="Descuento?accion=details&id=<%=descuento.getId()%>" 
                                                   title="Ver" class="waves-effect waves-light btn blue">
                                                    <i class="material-icons">description</i>
                                                </a>
                                                <a href="Descuento?accion=delete&id=<%=descuento.getId()%>" 
